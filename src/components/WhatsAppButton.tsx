...
export default function WhatsAppButton() {
  return (
    ...
    >
      {/* Mobile */}
      <div className="flex sm:hidden items-center justify-center h-14 w-14 rounded-full bg-primary border border-gold/30 shadow-[0_10px_24px_rgba(0,0,0,0.18)] transition-all duration-300 group-hover:scale-105 group-hover:shadow-[0_14px_30px_rgba(0,0,0,0.22)]">
        <svg
          viewBox="0 0 32 32"
