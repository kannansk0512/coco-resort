      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 font-body mt-6 font-light max-w-2xl mx-auto">
            {HOTEL.tagline} — Surrounded by the Western Ghats, enjoy year-round
            pleasant weather and unmatched tranquility.
          </p>
    ...
    <section className="section-padding">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <span className="text-xs uppercase tracking-[0.3em] text-gold font-body font-bold">
            About Us
          </span>
          ...
          <p className="mt-4 font-body text-muted-foreground leading-relaxed">
            With our warm hospitality, world-class amenities, and proximity to
            nature&apos;s wonders including the Anamalai Tiger Reserve and
            Amaravathi Dam, every moment at UDS COCO is an experience to cherish.
          </p>
          <div className="mt-8 flex gap-8">
            <div>
              ...
              <p className="text-xs uppercase tracking-widest text-muted-foreground font-body mt-1">
                Guest Rating
              </p>
            </div>
            <div>
